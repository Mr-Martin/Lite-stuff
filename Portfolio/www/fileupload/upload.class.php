...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true) {
        $this->options = array(
			...
			'database' => '163804-martin',
			'host' => 'martin-163804.mysql.binero.se',
			'username' => '163804_fu41156',
			'password' => 'nhy6mju7',
			// end
	...
	function query($query) {
		...
		{
		$add_to_db = $this->query("INSERT INTO gallery (filename) VALUES ('".$whichimg."')") or die(mysql_error());
		return $add_to_db;
		}
		...
		{
		$delete_from_db = $this->query("DELETE FROM gallery WHERE filename = '$delimg'") or die(mysql_error());
